...
<div class="login-box">
 ...
 alt=""style="display: block; margin: auto; max-width: 100%;">
  ...
  <div class="card card-outline card-primary">
    ...
    <a href="../public/templates/AdminLTE-3.2.0/index2.html" class="h1"><b>¿Eres un nuevo miembro? </b>Regístrate.</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Por favor ingrese sus credenciales.</p>
